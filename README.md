...
- [Task Contract](docs/operations/TASK_CONTRACT.md)
- [Task Lifecycle](docs/operations/TASK_LIFECYCLE.md)
...
- [PR Metadata Guard](docs/operations/PR_METADATA_GUARD.md)
- [Allowed-Files Guard](docs/ALLOWED_FILES_GUARD.md)
- [Codex Task Preflight](docs/operations/CODEX_TASK_PREFLIGHT.md)
- [Codex Fixed Loop Contracts](docs/operations/CODEX_FIXED_LOOP_CONTRACTS.md)
...
- [Risk Policy](docs/operations/RISK_POLICY.md)
- [Acceptance Tests](docs/ACCEPTANCE_TESTS.md)
- [GitHub Operating Policy](docs/operations/GITHUB_OPERATING_POLICY.md)
