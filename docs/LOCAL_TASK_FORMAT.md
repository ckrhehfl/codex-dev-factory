...
- `factory task plan` may later turn a valid task into an execution plan while preserving scope, non-goals, allowed files, forbidden files, forbidden actions, validation plan, stop conditions, risk tier, and owner decision requirements.
